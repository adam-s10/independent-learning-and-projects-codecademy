...
def a_star(graph, start, target, heuristic):
    argument = 'Euclidean' if heuristic == euclidean_heuristic else 'Manhattan'
    print(f"Starting A* algorithm with {argument} Heuristic")
    count = 0
    paths_and_distances = {}
    for vertex in graph:
...
a_star(euclidean_graph, bengaluru, jaipur, euclidean_heuristic)
