...
landmark_string = ''
for key, item in landmark_choices.items():
    landmark_string += f'{key} - {item}\n'
...
def set_start_and_end(start_point, end_point):
    if start_point is not None:
        change_point = input('What would you like to change? You can enter \'o\' for \'origin\', \'d\' for '
...
def get_active_stations():
    ...
    for station_under_construction in stations_under_construction:
        for current_station, neighbor in vc_metro.items():
...
# ************** TESTING **************
# print(get_route('Science World', 'Vancouver Aquarium'))
