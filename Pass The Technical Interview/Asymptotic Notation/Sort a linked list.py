...
message = "The sorted linked list is:\n{0}"
# Test Cases
ll = LinkedList("Z")
ll.insert_beginning("C")
ll.insert_beginning("Q")
ll.insert_beginning("A")
print(message.format(sort_linked_list(ll).stringify_list()))
...
print(message.format(sort_linked_list(ll_2).stringify_list()))
...
print(message.format(sort_linked_list(ll_3).stringify_list()))
